...
{
private:
	string firstName, secondName, pos, yrs, id, NIC, telNum, mail;
	char date[60], time[60];
	int age, salary;
public:
	UserInfo(); //Constructor
	UserInfo(int t); //Constructor with input parameter
	void getDetails(int t, string f1, string f2, string f3); 	// Getting Information of the staff & doctors
	void showDetails(int t, string f1);					// Displaying information of the staff & doctors
	void showList(int t, string f1);						// Displaying names of the staff & doctors
	void availability(int t, string f1); 					// Displaying available times of the staff & doctors
	void modifyDetails(int t, string f1, string f2); 		// Updating the information of the staff & doctors
	void deleteDetails(int t, string f1, string f2); 		// Deleting the informations of the staff & doctors
...
//member functions
void UserInfo::getDetails(int t, string f1, string f2, string f3) // Getting Information of the staff & doctors
{
	system("cls");
	if (t == 1)
...
void UserInfo::showDetails(int t, string f1) // Displaying information of the staff & doctors
{
	system("cls");
	if (t == 1)
...
void UserInfo::showList(int t, string f1) 	// Displaying names of the staff & doctors
{
	if (t == 1)
...
void UserInfo::availability(int t, string f1) 	// Displaying available times of the staff & doctors
{
	if (t == 1)
...
void UserInfo::modifyDetails(int t, string f1, string f2) // Updating the information of the staff & doctors
{
	system("cls");
	if (t == 1)
...
void UserInfo::deleteDetails(int t, string f1, string f2) // Deleting the informations of the staff & doctors
{
	system("cls");
	if (t == 1)
...
public:
	...
	void getDetails(int t, int type, int id, string f1); 						//getting details of the patient
	void showDetails(int t, int type, int id, string f1); 						//displaying details of the patient
	void modifyDetails(int t, int type, int id, string f1, string f2); 			//updating the details of the patient
	void deleteDetails(int t, int type, int id, string f1, string f2, string f3);	//deleting the details of the patient
...
//member functions
void PatientInfo::getDetails(int t, int type, int id, string f1) //getting details of the patient
{
	if (t == 1)
...
void PatientInfo::showDetails(int t, int type, int id, string f1) //displaying details of the patient
{
	if (t == 1)
...
void PatientInfo::modifyDetails(int t, int type, int id, string f1, string f2) 	//updating the details of the patient
{
	system("cls");
	if (t == 1)
...
void PatientInfo::deleteDetails(int t, int type, int id, string f1, string f2, string f3) //deleting the details of the patient
{
	system("cls");
	if (t == 1)
...
void updatePatient(int t)	//Updating patient information by admin
{
	...
	if (option1 == 1)
	{
		...
		else if (option2 == 3)
		{
			...
			remove("patients.txt");
			rename("patients2.txt", "patients.txt");
		}
		else if (option2 == 4)
		{
	...
	else if (option1 == 2)
	{
		...
		else if (option2 == 3)
		{
			...
			remove("telemedicine.txt");
			rename("telemedicine2.txt", "telemedicine.txt");
		}
		else if (option2 == 4)
		{
	...
	else if (option1 == 3)
	{
		...
		EGuardientInfo eGI1(t); //create object
		cout << "\n\n\t\t\t ........... Emergency Patients ...........\n";
		...
		if (option2 == 1)
		{
			...
			eGI1.getDetails(t, 5, eGI1.AppoinmentNo4, "Emergency_guardient.txt");
		}
		else if (option2 == 2)
		{
			eP1.showDetails(t, option1, eP1.AppoinmentNo2, "emergency.txt");
			eGI1.showDetails(t, 5, eGI1.AppoinmentNo4, "Emergency_guardient.txt");
		}
		else if (option2 == 3)
		{
			eP1.modifyDetails(t, option1, eP1.AppoinmentNo2, "emergency.txt", "emergency2.txt");
			remove("emergency.txt");
			rename("emergency2.txt", "emergency.txt");
			eGI1.modifyDetails(t, 5, eGI1.AppoinmentNo4, "Emergency_guardient.txt", "Emergency_guardient2.txt");
			remove("Emergency_guardient.txt");
			rename("Emergency_guardient2.txt", "Emergency_guardient.txt");
		}
		else if (option2 == 4)
		{
			...
			remove("emergency.txt");
			rename("emergency2.txt", "emergency.txt");
			eGI1.deleteDetails(t, 5, eGI1.AppoinmentNo4, "Emergency_guardient.txt", "Emergency_guardient2.txt", "Discharge_Emergency_guardient.txt");
			remove("Emergency_guardient.txt");
			rename("Emergency_guardient2.txt", "Emergency_guardient.txt");
		}
		else
	...
	else if (option1 == 4)
	{
		...
		else if (option2 == 3)
		{
			...
			remove("admitted.txt");
			rename("admitted2.txt", "admitted.txt");
			gI1.modifyDetails(t, 5, gI1.AppoinmentNo5, "Admitted_guardient.txt", "Admitted_guardient2.txt");
			remove("Admitted_guardient.txt");
			rename("Admitted_guardient2.txt", "Admitted_guardient.txt");
		}
		else if (option2 == 4)
		{
	...
	else if (option1 == 5)
	{
		...
		{
			EGuardientInfo eGI2(t); //create object
			eGI2.showDetails(t, 5, eGI2.AppoinmentNo4, "Discharge_Emergency_guardient.txt");
		}
		else if (option2 == 3)
		{
